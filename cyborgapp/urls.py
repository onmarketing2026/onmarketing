...
urlpatterns = [
    ...
    path('superadmin/target-achievements/', views.target_achievement_list, name='target_achievement_list'),
    path('superadmin/incentives/', views.incentive_list, name='incentive_list'),
    path('superadmin/incentives/create/', views.incentive_create, name='incentive_create'),
    path('superadmin/incentives/<int:pk>/toggle/', views.incentive_toggle_status, name='incentive_toggle_status'),
    path('superadmin/incentives/<int:pk>/edit/', views.incentive_edit, name='incentive_edit'),
    path('superadmin/incentives/<int:pk>/delete/', views.incentive_delete, name='incentive_delete'),
    path('superadmin/incentives/api/users/', views.incentives_get_users_api, name='incentives_get_users_api'),
